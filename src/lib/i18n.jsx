...
export const translations = {
  ...
  en: {
    ...
    bdor_2014_p3:
      "The first is internal to Real Madrid: in the finals that defined the season, Ronaldo was rarely the decisive figure. Gareth Bale was the most influential in both the Champions League final and the Copa del Rey final. Sergio Ramos scored the goal that took the Champions League final to extra time. Di María was voted the best player on the pitch in that same final. Ronaldo scored a penalty already in extra time, with the game controlled. <strong>He scored, yes — but on a stage where others were more important.</strong>",
    bdor_2014_p4:
