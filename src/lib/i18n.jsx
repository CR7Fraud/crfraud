...
export const translations = {
  pt: {
    ...
    bdor_2014_p7:
      "Em retrospectiva, Neuer foi o mais importante em campo ao longo do ano, Messi foi o melhor jogador do principal torneio de seleções, venceu o prémio de melhor jogador do Mundial de 2014 ao chegar à final e teve estatísticas nessa época praticamente ao nível das de Ronaldo, muito boas. Ronaldo foi o melhor marcador de um clube que ganhou muitos títulos, sim marcou muito e ganhou, mas o protagonismo nos jogos importantes foi para outros e no Mundial foi uma desgraça. É discutível, mas a decisão não era óbvia.",
    bdor_2016_p1:
    ...
    bdor_2016_p5:
      "O que aconteceu em 2016 é um caso claro de prémio baseado em troféus colectivos - que é um critério legítimo, mas sem que o jogador premiado fosse o protagonista real em nenhum deles. Os colegas de equipa no Real Madrid e em Portugal têm tanto mérito nesses títulos quanto Ronaldo, e em vários momentos decisivos, mais. A Bola de Ouro de 2016 não foi atribuída ao melhor jogador do ano - foi atribuída ao jogador que pertenceu às duas equipas vencedoras. São critérios diferentes, e vale a pena ser honesto sobre essa distinção. Os critérios, por outras palavras, mudaram consoante quem favoreciam. Quando Messi fez 59 golos + 31 assistências (91 g/a) sem um título da Champions League, isso não foi suficiente. Mas quando Ronaldo marcou 69 golos + 18 assistências (87 g/a) sem qualquer título em 2013, foi. Não existe um princípio consistente que explique ambos os resultados ao mesmo tempo - apenas um resultado.",
    bdor_2017_p1:
  ...
  en: {
    ...
    bdor_2014_p7:
      "In retrospect, Neuer was the most important player on the pitch throughout the year, Messi was the best player in the main international tournament, won the 2014 World Cup's best-player award by reaching the final and had numbers that season practically on par with Ronaldo's, both very strong. Ronaldo was the top scorer at a club that won many titles, yes he scored a lot and won, but the protagonism in the big games went to others and the World Cup was a disaster. It is debatable, but the decision was not obvious.",
    bdor_2016_p1:
    ...
    bdor_2016_p2:
      "In the Champions League, Ronaldo was the top scorer with 16 goals — but 11 of them came in the group stage, in games against Malmö FF and Shakhtar. In the round of 16 he scored against Roma and in the quarter-finals against Wolfsburg; from the semi-finals onwards and in the final, he did not score. The final MVP was Sergio Ramos.",
    bdor_2016_p3:
      "At Euro 2016, Portugal's campaign started with negative results: zero wins in the group stage, finishing third, a missed penalty against Austria. In the knockout rounds, Ronaldo scored against Hungary and Wales, but the moments that truly defined the tournament were delivered by others. Against Croatia, the decisive goal was Quaresma's; in the final against France, Ronaldo went off injured at 25 minutes and Portugal won 1-0 thanks to Éder's goal and a defensive display led by Pepe and Rui Patrício. The best player of the Euro was Antoine Griezmann.",
    bdor_2016_p4:
    ...
    bdor_2016_p5:
      "What happened in 2016 is a clear case of an award based on collective trophies — which is a legitimate criterion, but without the awarded player being the real protagonist in any of them. Teammates at Real Madrid and in Portugal have as much merit in those titles as Ronaldo does, and in several decisive moments, more. The 2016 Ballon d'Or was not awarded to the best player of the year — it was awarded to the player who belonged to the two winning teams. Those are different criteria, and it is worth being honest about that distinction. The criteria, in other words, shifted depending on who they favoured. When Messi had 59 goals + 31 assists (91 g/a) without a Champions League title, that was not enough. But when Ronaldo scored 69 goals + 18 assists (87 g/a) without any title in 2013, it was. There is no consistent principle that explains both outcomes simultaneously — only a result.",
    bdor_2017_p1:
  ...
  es: {
    ...
    bdor_2014_p7:
      "En retrospectiva, Neuer fue el jugador más importante sobre el campo durante todo el año, Messi fue el mejor jugador del principal torneo de selecciones, ganó el premio al mejor jugador del Mundial de 2014 al llegar a la final y tuvo estadísticas en esa época prácticamente al nivel de las de Ronaldo, muy buenas. Ronaldo fue el máximo goleador de un club que ganó muchos títulos, sí marcó mucho y ganó, pero el protagonismo en los partidos importantes fue para otros y en el Mundial fue un desastre. Es discutible, pero la decisión no era obvia.",
    bdor_2016_p1:
  ...
  fr: {
    ...
    bdor_2014_p7:
      "En rétrospective, Neuer a été le joueur le plus important sur le terrain tout au long de l'année, Messi a été le meilleur joueur du principal tournoi des sélections, a remporté le prix du meilleur joueur de la Coupe du monde 2014 en atteignant la finale et a eu des statistiques à cette période pratiquement au niveau de celles de Ronaldo, très bonnes. Ronaldo a été le meilleur buteur d'un club qui a remporté de nombreux titres, oui il a beaucoup marqué et gagné, mais le protagonisme dans les grands matches est revenu à d'autres et la Coupe du monde a été une catastrophe. C'est discutable, mais la décision n'était pas évidente.",
    bdor_2016_p1:
