...
const content = {
  en: {
    ...
    quote2:
      'The phrase attributed to Ronaldo in that context — "After everything I\'ve done for you, and this is how you treat me?" — captures the logic that runs through his career: collective defensive effort is optional for someone who scores goals. Demanding it is seen as ingratitude.',
    ...
    quote3:
      "\"When I cried, it wasn't because I felt that if I didn't score Portugal would be eliminated and the world would collapse on top of me. It wasn't that… People don't know me. Imagine you score the last 27 penalties. And in that moment you miss, and you feel bad about yourself.\"",
    quote4:
      "\"I didn't even think about Portugal being eliminated. I was sad because of the pressure I've put on myself since I was 11 years old.\"",
  ...
  pt: {
    ...
    quote1:
      'Gullit voltou ao tema: "O comportamento é inaceitável. São lágrimas de crocodilo - chorou porque falhou ele, não porque a equipa podia perder."',
    h3: "Fora de Campo",
    ...
    quote2:
      'A frase atribuída a Ronaldo nesse contexto - "Depois de tudo o que fiz por ti, e assim que me tratas?" - condensa a lógica que atravessa a sua carreira: o esforço defensivo coletivo é opcional para quem marca golos.',
    ...
    quote3:
      '"Quando chorei, não foi porque senti que se não marcasse Portugal seria eliminado e o mundo ia desabar em cima de mim. Não foi por isso… As pessoas não me conhecem. Imagina que marcas os últimos 27 penáltis. E naquele momento falhas, e sentes-te mal contigo mesmo."',
    quote4:
      '"Nem sequer pensei em Portugal ser eliminado. Fiquei triste por causa da pressão que coloco em mim próprio desde os 11 anos."',
  ...
  es: {
    title: "Egoísmo en y fuera del campo",
    h1: '"No persigo récords" - pero vive para ellos',
    p1: 'Ronaldo repite desde hace años la frase: "No persigo récords, los récords me persiguen". Suena bien en las entrevistas, pero la forma en que gestionó el final de su carrera dice lo contrario.',
    p2: "Se mantuvo en la selección mucho después de su pico competitivo, insistiendo en ser titular en Eurocopas y Mundiales donde era uno de los jugadores menos productivos del campo — sobre todo para acumular partidos internacionales y goles. Eligió la liga de Arabia Saudí, muy por debajo del nivel competitivo de la élite europea, justo cuando ya no tenía mercado en lo más alto — pero donde podía seguir sumando goles y partidos en un contexto mucho menos exigente. Sigue intentando monopolizar penaltis y libres, incluso con baja eficacia y con compañeros más fuertes en ese momento del juego.",
  ...
  fr: {
    title: "Égoïsme sur et hors du terrain",
    h1: '"Je ne chasse pas les records" - mais il vit pour eux',
    p1: 'Ronaldo répète depuis des années la phrase : "Je ne chasse pas les records, les records me chassent". Cela sonne bien en interview, mais la manière dont il a géré la fin de sa carrière dit exactement l’inverse.',
