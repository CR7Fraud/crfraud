...
const content = {
  en: {
    ...
    p5: 'Two years later, he signs for Al-Nassr in a deal estimated at over €200 million per season and becomes, in effect, the global poster boy of the Saudi league and the regime\'s "Vision 2030". Amnesty International stated clearly that the signing is "part of a <span style="color: hsl(var(--accent))">sportswashing strategy</span>" and called on Ronaldo to use his platform to speak about political prisoners and gender inequality, rather than just praising the country.',
    p6: 'In a country where women were for decades treated as legal dependants of a male guardian, where gender equality activists were imprisoned and tortured, seeing Ronaldo help sell the image of a "cool new destination" is hard to reconcile with the 2021 version who allegedly <span style="color: hsl(var(--accent))">turned down €10 million on principle</span>. Human rights were a problem when the cheque was small; they stopped being one when the number of zeros changed.',
