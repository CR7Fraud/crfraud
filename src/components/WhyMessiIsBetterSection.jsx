...
const content = {
  ...
  es: {
    ...
    li1: "Messi: 903 goles, 407 asistencias, 1.146 partidos.",
    li2: "Ronaldo: 967 goles, 261 asistencias, 1.313 partidos.",
    p2: "Esto significa:",
    li3: "Messi decide más veces por partido: un gol cada 104 minutos, una contribución de gol (gol+asistencia) cada 72 minutos.",
    li4: "Ronaldo necesita más tiempo: 111 minutos por gol y 87 minutos por gol+asistencia.",
    ...
    li6: "Desde fuera del área: Messi tiene 132 goles desde fuera del área contra 74 de Ronaldo — casi el doble.",
    ...
    p5: "Y en el remate:",
    li8: "Messi necesita menos disparos por gol (5,36 vs 6,52) y marca más rápido.",
    ...
    li11: "Messi también tiene muchísimos más pases clave y pre-asistencias a lo largo de su carrera — más de 1.700 pases clave frente a unos 1.250 de Ronaldo.",
    p8: "En la práctica:",
    li12: "Ronaldo es sobre todo un finalizador.",
    li13: "Messi es un finalizador de élite + un creador de élite.",
    p9: "Por eso, cuando comparas contribuciones totales (goles + asistencias), Messi tiene 1.310 contribuciones frente a 1.228 de Ronaldo, y decide un gol cada 72 minutos, frente a 87 para Ronaldo.",
    ...
    li15: "Títulos (clubes + selección): Messi es, en 2026, el jugador masculino más laureado de la historia, con alrededor de 47-48 trofeos, mientras Ronaldo se queda algo por detrás.",
    li16: "En finales, Messi jugó más (46 vs 37), ganó más (33 vs 25) y tiene más goles (37 vs 25) y asistencias (19 vs 2).",
    p11: "Selección:",
  ...
  fr: {
    ...
    li1: "Messi : 903 buts, 407 passes décisives, 1 146 matches.",
    li2: "Ronaldo : 967 buts, 261 passes décisives, 1 313 matches.",
    p2: "Cela signifie :",
    li3: "Messi décide plus souvent par match : un but toutes les 104 minutes, une contribution au but (but+assist) toutes les 72 minutes.",
    li4: "Ronaldo a besoin de plus de temps : 111 minutes par but et 87 minutes par but+assist.",
    ...
    li6: "De l’extérieur de la surface : Messi en a 132 contre 74 pour Ronaldo — presque le double.",
    ...
    p5: "Et au tir :",
    li8: "Messi a besoin de moins de tirs par but (5,36 contre 6,52) et marque plus vite.",
    ...
    li11: "Messi a aussi beaucoup plus de passes clés et de pré-assists sur l’ensemble de sa carrière — plus de 1 700 passes clés contre environ 1 250 pour Ronaldo.",
    p8: "En pratique :",
    li12: "Ronaldo est surtout un finisseur.",
    li13: "Messi est un finisseur d’élite + un créateur d’élite.",
    p9: "C’est pour cela que, lorsqu’on compare les contributions totales (buts + passes), Messi en a 1 310 contre 1 228 pour Ronaldo, et décide un but toutes les 72 minutes, contre 87 pour Ronaldo.",
    ...
    li15: "Titres (clubs + sélection) : Messi est, en 2026, le joueur masculin le plus titré de l’histoire, avec environ 47-48 trophées, tandis que Ronaldo reste un peu derrière.",
    li16: "En finales, Messi a joué plus (46 contre 37), gagné plus (33 contre 25) et a plus de buts (37 contre 25) et de passes décisives (19 contre 2).",
    p11: "Sélection :",
