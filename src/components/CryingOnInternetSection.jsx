...
const content = {
  en: {
    ...
    h2: "2. Offline tantrums",
    h2a: "Goodison Park",
    p6: 'In 2022, after a defeat against Everton, Ronaldo walks to the tunnel and <span style="color: hsl(var(--accent))">knocked the phone</span> out of the hand of a 14-year-old autistic boy. The mother describes her son as "in shock" and with an injured hand; the police open an investigation, as do Manchester United and the FA.',
    ...
    h4: "4. Al-Nassr drama",
    h4a: "Gestures and tears",
    p16: 'In Saudi Arabia, the "big kid" behaviour goes into permanent mode.',
    li1: 'In February 2024, he responds to "Messi" chants with an <span style="color: hsl(var(--accent))">obscene gesture</span> near his groin; the Saudi federation suspends him for one game and fines him.',
    ...
    li9: 'Uses stories to talk about "<span style="color: hsl(var(--accent))">95% of fake news</span>" and "the truth will come out", preparing attack-interviews where he is the betrayed one and everyone else — club, manager, board — is the problem.',
  ...
  pt: {
    ...
    h1: "1. Choros em campo",
    h1a: "Mundiais 2018 e 2022",
    ...
    h4: "4. Drama no Al-Nassr",
    h4a: "Gestos e lágrimas",
  ...
  es: {
    ...
    h1: "1. Llantos en el campo",
    h1a: "Mundiales 2018 y 2022",
    ...
    h1b: "Euro 2024: memes en directo",
    ...
    h4: "4. Drama en Al-Nassr",
    h4a: "Gestos y llantos",
  ...
  fr: {
    ...
    h1: "1. Pleurs sur le terrain",
    h1a: "Coupes du monde 2018 et 2022",
    ...
    h2b: "Bande-annonce de l'interview",
    ...
    h4: "4. Drame à Al-Nassr",
    h4a: "Gestes et pleurs",
...
export function CryingOnInternetBody({ lang }) {
  ...
  const divider = <div className="content-divider" />;
