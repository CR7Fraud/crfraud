...
const content = {
  en: {
    ...
    p6: 'In 2022, after a defeat against Everton, Ronaldo walks to the tunnel and **knocked the phone** out of the hand of a 14-year-old autistic boy. The mother describes her son as "in shock" and with an injured hand; the police open an investigation, as do Manchester United and the FA.',
