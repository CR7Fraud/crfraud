    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center bg-zinc-950 overflow-hidden pt-14">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="flex justify-center mb-8">
          <div className="w-16 h-16 bg-zinc-900 rounded-2xl border border-zinc-700 flex items-center justify-center shadow-2xl">
            <span className="font-playfair font-black text-2xl">
        ...
        <div className="mb-5 inline-flex items-center gap-2 bg-amber-500/10 border border-amber-500/25 rounded-full px-4 py-1.5">
          ...
          <span className="text-amber-400 text-xs font-semibold tracking-widest uppercase">{t('hero_tag')}</span>
        </div>
