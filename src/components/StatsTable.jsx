...
const FALLBACK_STATS_ES = [
  { label: "Goles", messi: "905", ronaldo: "969" },
  { label: "Asistencias", messi: "407", ronaldo: "261" },
  { label: "Partidos", messi: "1.150", ronaldo: "1.317" },
  { label: "Min/Gol", messi: "105", ronaldo: "111" },
  { label: "Min/Contribución", messi: "72", ronaldo: "88" },
  { label: "Goles fuera del área", messi: "106", ronaldo: "72" },
  { label: "Goles de falta", messi: "71", ronaldo: "64" },
  { label: "Tiros a puerta", messi: "1.914", ronaldo: "2.122" },
  { label: "Pases clave", messi: "2.061", ronaldo: "1.301" },
  { label: "Balones de Oro", messi: "8", ronaldo: "5" },
];

const FALLBACK_STATS_FR = [
  { label: "Buts", messi: "905", ronaldo: "969" },
  { label: "Passes décisives", messi: "407", ronaldo: "261" },
  { label: "Matches", messi: "1.150", ronaldo: "1.317" },
  { label: "Min/But", messi: "105", ronaldo: "111" },
  { label: "Min/Contribution", messi: "72", ronaldo: "88" },
  { label: "Buts hors de la surface", messi: "106", ronaldo: "72" },
  { label: "Buts sur coup franc", messi: "71", ronaldo: "64" },
  { label: "Tirs cadrés", messi: "1.914", ronaldo: "2.122" },
  { label: "Passes clés", messi: "2.061", ronaldo: "1.301" },
  { label: "Ballons d'Or", messi: "8", ronaldo: "5" },
];
