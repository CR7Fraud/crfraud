...
{ path: '/selfishness', key: 'nav_selfish', icon: '🎭', desc: 'selfish_desc' },
{ path: '/national-team', key: 'nav_national', icon: '🇵🇹', desc: 'national_desc' },
{ path: '/crying', key: 'nav_crying', icon: '😭', desc: 'crying_desc' },
{ path: '/hypocrisy', key: 'nav_hypocrisy', icon: '🎪', desc: 'hypocrisy_desc' },
{ path: '/liga-comprada', key: 'nav_liga', icon: '💰', desc: 'liga_desc' },
{ path: '/why-messi', key: 'nav_messi', icon: '⭐', desc: 'messi_desc' }];

const cardDescs = {
  pt: {
    ballon_desc: 'Análise das 5 Bolas de Ouro de Ronaldo e o padrão que as une.',
    ucl_desc: 'As polémicas arbitrais que moldaram a era de Champions do Real Madrid.',
    managers_desc: 'Dezasseis anos. Quatro clubes. Os treinadores que pagaram a conta.',
    ...
    crying_desc: 'Drama nas redes sociais e a máquina de manipulação mediática.',
  ...
  en: {
    ballon_desc: "Analysis of Ronaldo's 5 Ballon d'Ors and the pattern connecting them.",
    ucl_desc: 'The refereeing controversies that shaped Real Madrid\'s Champions era.',
    managers_desc: 'Sixteen years. Four clubs. The managers who paid the price.',
  ...
  es: {
    ballon_desc: 'Análisis de los 5 Balones de Oro de Ronaldo y el patrón que los une.',
    ucl_desc: 'Las polémicas arbitrales que moldearon la era Champions del Real Madrid.',
    managers_desc: 'Dieciséis años. Cuatro clubes. Los entrenadores que pagaron la cuenta.',
    ...
    crying_desc: 'Drama en redes sociales y la máquina de manipulación mediática.',
  ...
  fr: {
    ballon_desc: "Analyse des 5 Ballons d'Or de Ronaldo et le schéma qui les relie.",
    ucl_desc: "Les controverses arbitrales qui ont façonné l'ère Champions du Real Madrid.",
    managers_desc: 'Seize ans. Quatre clubs. Les entraîneurs qui ont payé le prix.',
    ...
    crying_desc: 'Drama sur les réseaux sociaux et la machine de manipulation médiatique.',
    hypocrisy_desc: 'Ce qu\'il a dit, ce qu\'il a fait, et la différence entre les deux.',
      ...
      <main className="max-w-5xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          className="group block p-6 rounded-2xl border border-border bg-card hover:border-amber-400/50 hover:shadow-lg transition-all duration-200">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">{descs[card.desc]}</p>
              <span className="mt-4 inline-flex items-center text-xs font-semibold text-amber-500 gap-1">
                {lang === 'pt' ? 'Ler →' : lang === 'es' ? 'Leer →' : lang === 'fr' ? 'Lire →' : 'Read →'}
              </span>
            </Link>
          )}
        </div>
